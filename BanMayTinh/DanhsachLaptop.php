      ...
      <div class="product-showcase" id="productRow">
        ...
        ?>
          <div class="product-card">
            <img src="../quantri/images-laptop/<?php echo $row['hinh_anh']; ?>" alt="<?php echo $row['ten_sp']; ?>" class="item-image">
            <div class="product-details">
              <h3 class="item-title"><?php echo $row['ten_sp']; ?></h3>
              <p class="item-price"><?php echo number_format($row['don_gia'], 0, ',', '.'); ?> VNĐ</p>
              <div class="product-buttons">
                <a onclick="addToCart(<?php echo $row['id_sp']; ?>, '<?php echo addslashes($row['ten_sp']); ?>', <?php echo $row['don_gia']; ?>, '<?php echo addslashes($row['hinh_anh']); ?>')" title="Mua ngay">
